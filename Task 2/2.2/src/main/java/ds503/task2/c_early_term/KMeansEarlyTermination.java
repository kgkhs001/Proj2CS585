...
public class KMeansEarlyTermination extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        if (args.length != 4) {
            System.err.println("Usage: KMeansEarlyTermination <input> <output_base> <centroid> <num_iterations>");
            System.exit(2);
        }
...
/*
How to run:
hdfs dfs -rm -r -f /output/kmeans_conv
hadoop jar task2-2-1.0-SNAPSHOT.jar ds503.task2.c_early_term.KMeansEarlyTermination ./Proj2/tuples.csv /output/kmeans_early ./Proj2/tuples_2.csv #ofIterations
*/